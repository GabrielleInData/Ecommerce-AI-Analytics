...
Due to repository size and data-distribution considerations, this repository includes a representative 5,000-row sample (`amazon_reviews_sample.csv`) rather than the complete dataset, and Image_Training_Sample folder.
...
- Interactive Gradio prototype developed for product description generation
